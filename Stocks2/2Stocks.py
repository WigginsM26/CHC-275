def readstockdata(filename):
    """Read stock tickers and their 20 prices from a file."""
    tickers = []
    prices = []
    try:
...
def generatereport(tickers1, prices1, prices2, filename):
    """Generate a report comparing averages from two 20-day snapshots."""
    try:
        ...
        file.write("Stock Report: 20-Day Average Comparison\n")
        file.write("=======================================\n\n")
        ...
        for i in range(len(tickers1)):
            ...
            file.write(ticker + "\n")
            file.write("  Days 1-20 average: " + str(round(avg1, 2)) + "\n")
            file.write("  Days 21-40 average: " + str(round(avg2, 2)) + "\n")

            if avg2 > avg1:
                file.write("  Recommendation: BUY (Upward trend)\n\n")
            else:
                file.write("  Recommendation: DON'T BUY (No upward trend)\n\n")
